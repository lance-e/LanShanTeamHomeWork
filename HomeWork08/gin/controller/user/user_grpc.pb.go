...
const (
	...
	LServer_GetInfo_FullMethodName = "/LServer/GetInfo"
	LServer_Star_FullMethodName    = "/LServer/Star"
)
...
type LServerClient interface {
	...
	GetInfo(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*Response, error)
	Star(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *lServerClient) GetInfo(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, LServer_GetInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lServerClient) Star(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, LServer_Star_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LServerServer interface {
	...
	GetInfo(context.Context, *UserInfo) (*Response, error)
	Star(context.Context, *UserInfo) (*Response, error)
...
func (UnimplementedLServerServer) GetInfo(context.Context, *UserInfo) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetInfo not implemented")
}
func (UnimplementedLServerServer) Star(context.Context, *UserInfo) (*Response, error) {
...
func _LServer_GetInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LServerServer).GetInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LServer_GetInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LServerServer).GetInfo(ctx, req.(*UserInfo))
	}
	return interceptor(ctx, in, info, handler)
}

func _LServer_Star_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LServerServer).Star(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LServer_Star_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LServerServer).Star(ctx, req.(*UserInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetInfo",
			Handler:    _LServer_GetInfo_Handler,
		},
		{
			MethodName: "Star",
			Handler:    _LServer_Star_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "user.proto",
